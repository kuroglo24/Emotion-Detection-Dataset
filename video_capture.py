...
model_state = torch.load("./models/emotion_detection_model_state.pth", map_location="cpu")
...
#model.to(device="cpu")
#model=torch.load("./models/emotion_detection_model_state.pth", map_location="cpu")
